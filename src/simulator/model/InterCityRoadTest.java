...
class InterCityRoadTest {
	...
	void test_basic_info() {
		...
		// contamination limit
		assertEquals(500, r1.getContAlarmLimit());
	...
	void test_1() {
		...
		// check speed
		assertEquals(50, v1.getCurrentSpeed());
		assertEquals(100, v2.getCurrentSpeed());

		// check correctness of total co2
		assertEquals(350, r1.getTotalCont());
		assertEquals(50, v1.getTotalCont());
		assertEquals(300, v2.getTotalCont());
		...
		assertEquals(40, v1.getCurrentSpeed());
		assertEquals(40, v2.getCurrentSpeed());

		// check correctness of total co2
		assertEquals(440, r1.getTotalCont());
		assertEquals(90, v1.getTotalCont());
		assertEquals(420, v2.getTotalCont());
	}
